...
async def get_room_in_apartment(room_id: int, apartment: Apartment = Depends(get_apartment)):
...
async def get_apartment_obj(data: CreateRoomWithApartment, user: User = Depends(get_current_user_obj)):
